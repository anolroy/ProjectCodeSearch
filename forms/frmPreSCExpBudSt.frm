...
Begin VB.Form frmPreSCExpBudSt 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Service Charge Budget Statement Report"
   ClientHeight    =   6465
   ClientLeft      =   1125
   ClientTop       =   1935
   ClientWidth     =   8355
   ...
   EndProperty
   Icon            =   "frmPreSCExpBudSt.frx":0000
   LinkTopic       =   "Form2"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   End
End
Attribute VB_Name = "frmPreSCExpBudSt"
...
Private Sub cmdSCYRRPrint_Click()
   ...
   Set Report = reportApp.OpenReport(App.Path & szReportPath & "\SCExpBudSt.rpt")
