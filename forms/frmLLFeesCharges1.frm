...
Begin VB.Form frmLLFeesCharges1 
   ...
   EndProperty
   Icon            =   "frmLLFeesCharges1.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   Begin TabDlg.SSTab tabFees 
      ...
      TabPicture(0)   =   "frmLLFeesCharges1.frx":1982
      Tab(0).ControlEnabled=   0   'False
      Tab(0).Control(0)=   "cmdRechargeGenerate"
      Tab(0).Control(1)=   "txtSetRechargeDate"
      Tab(0).Control(2)=   "Label5"
      Tab(0).Control(3)=   "flxRecharge"
      Tab(0).Control(4)=   "cmdRechargeConfirmed"
      Tab(0).Control(5)=   "Frame1"
      Tab(0).ControlCount=   6
      TabCaption(1)   =   "Agent Fees"
      TabPicture(1)   =   "frmLLFeesCharges1.frx":199E
      Tab(1).ControlEnabled=   0   'False
      Tab(1).Control(0)=   "MSHFlexGrid2"
      Tab(1).Control(1)=   "Command6"
      Tab(1).ControlCount=   2
      TabCaption(2)   =   "Management Fee"
      TabPicture(2)   =   "frmLLFeesCharges1.frx":19BA
      Tab(2).ControlEnabled=   -1  'True
      Tab(2).Control(0)=   "MSHFlexGrid3"
      Tab(2).Control(0).Enabled=   0   'False
      Tab(2).ControlCount=   1
      TabCaption(3)   =   "Rent Payable"
      TabPicture(3)   =   "frmLLFeesCharges1.frx":19D6
...
'/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*
'     FOR THE BLOCK MANAGEMENT THIS FORM NEEDS OT BE CHANGED
'           frmFeesCharges1.frm IS THE NEW FORM
'     THIS FORM BASICALLY NEEDS FOR LETTNG MANAGEMENT
'/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*
