...
Begin VB.Form frmManagingAgent3 
   ...
   EndProperty
   Icon            =   "frmManagingAgent3.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   Begin VB.Frame Frame3 
      ...
      Begin VB.CommandButton cmdCloseSupplier 
         ...
         Width           =   1215
      End
      Begin VB.CommandButton cmdDeleteMA 
         Caption         =   "&Delete"
         Height          =   345
         Left            =   7065
         TabIndex        =   14
   ...
   Begin TabDlg.SSTab tabSupplier 
      ...
      TabPicture(0)   =   "frmManagingAgent3.frx":08CA
      ...
      Tab(0).Control(5)=   "cmdSaveFirstTab"
      Tab(0).Control(5).Enabled=   0   'False
      Tab(0).Control(6)=   "cmdUpdateSuAddress"
      Tab(0).Control(6).Enabled=   0   'False
      Tab(0).Control(7)=   "cmdFcancel"
      Tab(0).Control(7).Enabled=   0   'False
      Tab(0).ControlCount=   8
      TabCaption(1)   =   "Payments"
      TabPicture(1)   =   "frmManagingAgent3.frx":08E6
      Tab(1).ControlEnabled=   0   'False
      Tab(1).Control(0)=   "Frame5"
      Tab(1).Control(1)=   "Frame4"
      Tab(1).Control(2)=   "txtFLX"
      Tab(1).Control(3)=   "cmdSavePayments"
      Tab(1).Control(4)=   "cmdEditPayments"
      Tab(1).Control(5)=   "cmdCancelPayments"
      Tab(1).Control(6)=   "cmdAccType"
      Tab(1).Control(7)=   "Label1(30)"
      Tab(1).Control(8)=   "Label1(29)"
      Tab(1).Control(9)=   "Label1(28)"
      Tab(1).Control(10)=   "Label1(27)"
      Tab(1).Control(11)=   "Label1(26)"
      Tab(1).Control(12)=   "Label1(33)"
      Tab(1).Control(13)=   "Label1(25)"
      Tab(1).Control(14)=   "Label1(32)"
      Tab(1).Control(15)=   "Label1(31)"
      Tab(1).Control(16)=   "cboAccType"
      Tab(1).Control(17)=   "Label3"
      Tab(1).Control(18)=   "Label2"
      Tab(1).ControlCount=   19
      TabCaption(2)   =   "Account History"
      TabPicture(2)   =   "frmManagingAgent3.frx":0902
      ...
      TabPicture(3)   =   "frmManagingAgent3.frx":091E
      Tab(3).ControlEnabled=   0   'False
      Tab(3).Control(0)=   "Frame8"
      Tab(3).Control(1)=   "Frame17"
      Tab(3).ControlCount=   2
      TabCaption(4)   =   "Contacts"
      TabPicture(4)   =   "frmManagingAgent3.frx":093A
      ...
      TabPicture(5)   =   "frmManagingAgent3.frx":0956
      ...
      Begin VB.TextBox txtAddress 
         ...
         MultiLine       =   -1  'True
         TabIndex        =   147
         Text            =   "frmManagingAgent3.frx":0972
         Top             =   1680
         Visible         =   0   'False
         Width           =   2295
      End
   ...
   End
End
Attribute VB_Name = "frmManagingAgent3"
...
'===========================================================================================
   If txtMAID.text = "" Then
      MsgBox "Please select a Mananaging Agent to delete.", vbInformation, "No selection"
      txtMAID.SetFocus
      Exit Sub
   End If
   ...
   conClient.Open getConnectionString
    szSQL = "SELECT * " & _
         "FROM tlbPayment " & _
         "WHERE SageAccountNumber = '" & txtMAID.text & "';"
    rstClient.Open szSQL, conClient, adOpenStatic, adLockReadOnly
    If Not rstClient.EOF Then
        MsgBox "This Managing agent could not be deleted. There are transactions in database related to this Managing agent" & _
   ...
   ' MousePointer = vbHourglass
    If MsgBox("Are you sure to delete current Managing agent?", vbYesNo + vbInformation, "Confimation") = vbNo Then Exit Sub
    
    
    conClient.Execute "DELETE  FROM Supplier WHERE SupplierID = '" & txtMAID.text & "' AND Type='AGENT';"
    
    
    conClient.Close
    Set conClient = Nothing
    
    MsgBox "Manageing agent has been deleted successfully.", vbOKOnly + vbInformation, "Delete Confirmation"
    cmdDeleteMA.Enabled = False
...
Private Sub cmdDelete_Click()
      ...
      adoConn.Execute "DELETE from MemoDetails where MemoID=" & Val(flxMemoDetails.TextMatrix(flxMemoDetails.row, 1)) & " and sageaccountNumber='" & txtMAID.text & "'"
...
Private Function SaveMemo() As Boolean
   ...
   If Not Memo_Save_mode Then
       sSQLFilter = "WHERE MemoID = " & Val(flxMemoDetails.TextMatrix(flxMemoDetails.row, 1)) & " AND Memotype='MangA' AND SageAccountNumber = '" & txtMAID.text & "'"
   Else
       sSQLFilter = ""
   End If
   sSQLQuery_ = "SELECT * " & _
   ...
   rstLeaseAnalysis_!MemoType = "MangA"
   rstLeaseAnalysis_!SageAccountNumber = txtMAID.text
...
Public Sub LoadGridMemo()
   ...
   Dim sSQLQuery_ As String
   conMemo.Open getConnectionString
   sSQLQuery_ = "SELECT * from MemoDetails where SageAccountNumber='" & txtMAID.text & "' And  MemoType='MangA' order by MemoID"
...
Public Sub LoadGridMaintenanceHistory(ByVal conMHistory_ As ADODB.Connection)
   ...
   szSQL = "SELECT IIF(RecordType = 'J', 'JOB', 'DIARY'), S.Value, " & _
           ...
           "WHERE H.AssignedTo = '" & txtMAID.text & "' " & _
...
Private Sub cmdCancelSupplier_Click()
   If (FORM_STATUS = "Edit") Then
      FORM_STATUS = txtMAID.text
      SetControls DefaultMode
      txtMAID.text = FORM_STATUS
...
Private Sub cmdClinetAddAtch_Click()
   ...
   AddNewAttachmentInCombo cmbFiles, "Supplier", txtMAID.text
...
Private Sub cmdDeleteFile_Click()
   ...
   DeleteAttachmentCombo cmbFiles, cmbFiles.Column(2), txtMAID.text, "Supplier"
...
Private Sub cmdFcancel_Click()
   ...
   adoConn.Open getConnectionString
   LoadValuesFirstTab txtMAID.text, adoConn
   adoConn.Close
...
Private Sub cmdSaveSupplier_Click()
   If txtSupplierName.text = "" Then
       ShowMsgInTaskBar "Please enter a Managing Agent Name to continue.", , "N"
       txtSupplierName.text = ""
       txtSupplierName.SetFocus
       Exit Sub
   End If
   If txtMAID.text = "" Then
       ShowMsgInTaskBar "Please enter a Managing Agent ID to continue.", , "N"
       txtMAID.text = ""
       txtMAID.SetFocus
       Exit Sub
   End If
   ...
   If (FORM_STATUS = "New") Then
      sSQLFilter = ""
   Else
      sSQLFilter = "WHERE SupplierID = '" & txtMAID.text & "'"
   End If
   ...
   If (FORM_STATUS = "New") Then
      rstMHistory_.AddNew
      rstMHistory_!SupplierID = txtMAID.text
...
'   rstMHistory_!SupplierMemo = txtNote.text
   ...
   MsgBox "Managing Agent entry has been saved successfully.", vbOKOnly, "Data Saved"

   SetControls EditMode
   
   FORM_STATUS = "DetEdit"
   Me.Caption = "Managing Agent"
...
Private Function IsSupplierExist_(ByRef SupplierID As String, adoConn As ADODB.Connection) As Boolean
   ...
   szSQL = "SELECT SupplierID FROM Supplier WHERE SupplierID = '" & SupplierID & "' AND TYPE = 'AGENT';"
...
Private Sub cmdSupplier_Click()
   ...
   picSupList.Top = txtMAID.Top + txtMAID.Height + 5
   picSupList.Left = txtMAID.Left + 5
...
Private Sub cmdSupplierType_Click(Index As Integer)
   ...
   frmSecondaryCode.PRIMARY_CODE_SHOW = "MAGENT"
   Load frmSecondaryCode
   frmSecondaryCode.Show 1
   ...
   sSQLQuery = "SELECT CODE, VALUE " & _
               "FROM SECONDARYCODE " & _
               "WHERE PRIMARYCODE = 'MAGENT' AND Code ='MA'"
...
Private Sub cmdTaxList_Click(Index As Integer)
   ...
   fraList(0).Width = 3620
   flxSupplier(0).Width = 3500
   cmdGridUnitClose(0).Left = fraList(0).Width - cmdGridUnitClose(0).Width - 60
   Shape4(0).Width = fraList(0).Width - 200
...
Private Sub cmdEditPayments_Click()
   ...
   If InStr(txtCodeVat.text, "/") Then
        temp = Split(txtCodeVat.text, "/")
        Label1(27).Caption = temp(0) 'lblVatCode(0).Caption
   Else
          Label1(27).Caption = ""
   End If
...
Private Sub flxSupplierList_Click()
  ...
  'End of modification
   ...
   txtMAID.text = flxSupplierList.TextMatrix(flxSupplierList.row, 1)

   Dim adoConn As New ADODB.Connection
   'Set the RDO Connections to the dataset
   adoConn.Open getConnectionString

   LoadValues txtMAID.text, adoConn
   LoadGridMaintenanceHistory adoConn

   adoConn.Close
   Set adoConn = Nothing

   Me.Caption = "Managing Agent: " & txtSupplierName.text
...
'   MousePointer = vbHourglass
   ...
   sSQLQuery_ = "SELECT S.SupplierID, S.SupplierName, S.SupplierAddressLine1, S.SupplierAddressLine2, " & _
                  ...
                  "S.BacsRef, S.SupplierType, S.creditlimit, S.nominalcode, " & _
                  "S.AccountType, S.PaymentType, S.PaymentTerms, S.SortCode, S.AcNo, S.AcName, S.BPR, " & _
                  "N.Name AS NN,S.optedtoTax,V.VAT_CODE,V.VAT_RATE " & _
                "FROM (Supplier AS S LEFT OUTER JOIN NominalLedger AS N " & _
                  "ON S.NominalCode = N.Code) LEFT OUTER JOIN tlbVatCode AS V " & _
...
'Debug.Print sSQLQuery_
   ...
   chkOptedtoTax.Value = IIf(rstRst!optedTotax = True, 1, 0)
   LoadAttachmentFiles cmbFiles, txtMAID.text, "Supplier"
...
Private Sub txtMAID_KeyPress(KeyAscii As MSForms.ReturnInteger)
...
Private Sub txtMAID_LostFocus()
   If txtMAID.Locked Then Exit Sub
...
Public Sub LoadFlxContact(adoConn As ADODB.Connection)
   ...
   szSQL = "SELECT * FROM Contacts WHERE WhosContact = 'S' AND HeadContact = '" & txtMAID.text & "';"
...
Private Sub LoadFlxACHistory(adoConn As ADODB.Connection)
   ...
   szSQL = "SELECT P.*, TT.DESCRIPTION AS TT_DES, PI.SlNumber AS INV_REF, TT.CONSTANT " & _
           ...
           "WHERE  P.SageAccountNumber = '" & txtMAID.text & "' AND P.Amount > 0 " & _
