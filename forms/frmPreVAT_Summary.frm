...
Begin VB.Form frmPreVAT_Summary 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "VAT Summary Report"
   ClientHeight    =   6690
   ClientLeft      =   1125
   ClientTop       =   1935
   ClientWidth     =   6945
   ...
   EndProperty
   Icon            =   "frmPreVAT_Summary.frx":0000
   LinkTopic       =   "Form2"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   End
End
Attribute VB_Name = "frmPreVAT_Summary"
...
Exit Sub
'  All option selected
   Set Report = reportApp.OpenReport(App.Path & szReportPath & "\Vat_Summary.rpt")

'   Report.Database.Tables(1).ConnectionProperties.Item("Database Password") = accessDBPws
    If txtVatPeriod.text = "" Then
            MsgBox "Please enter VAT Period"
            Exit Sub
    End If
    ...
    Report.ParameterFields(10).AddCurrentValue CInt(cboVAT_Trans_Type.Value)
     Report.ParameterFields(11).AddCurrentValue False
