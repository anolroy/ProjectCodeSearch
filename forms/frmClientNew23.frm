...
Begin VB.Form frmClientNew3 
   ...
   Begin TabDlg.SSTab tabMain 
      ...
      TabPicture(0)   =   "frmClientNew23.frx":08CA
      ...
      TabPicture(1)   =   "frmClientNew23.frx":08E6
      ...
      TabPicture(2)   =   "frmClientNew23.frx":0902
      ...
      Tab(2).Control(5)=   "cboRecharge_NONEED"
      ...
      Tab(2).Control(12)=   "Label7(0)"
      Tab(2).Control(12).Enabled=   0   'False
      Tab(2).Control(13)=   "Label7(1)"
      Tab(2).Control(13).Enabled=   0   'False
      Tab(2).Control(14)=   "Label7(2)"
      Tab(2).Control(14).Enabled=   0   'False
      Tab(2).Control(15)=   "Label7(3)"
      Tab(2).Control(15).Enabled=   0   'False
      Tab(2).Control(16)=   "Label7(4)"
      Tab(2).Control(16).Enabled=   0   'False
      Tab(2).Control(17)=   "Label7(5)"
      Tab(2).Control(17).Enabled=   0   'False
      Tab(2).Control(18)=   "Label7(6)"
      Tab(2).Control(18).Enabled=   0   'False
      Tab(2).Control(19)=   "Label7(7)"
      Tab(2).Control(19).Enabled=   0   'False
      Tab(2).Control(20)=   "Label7(8)"
      Tab(2).Control(20).Enabled=   0   'False
      Tab(2).Control(21)=   "flxAgreement"
      Tab(2).Control(21).Enabled=   0   'False
      Tab(2).Control(22)=   "cmdAgmntEdit"
      Tab(2).Control(22).Enabled=   0   'False
      Tab(2).Control(23)=   "cmdAgmntSave"
      Tab(2).Control(23).Enabled=   0   'False
      Tab(2).Control(24)=   "txtRRPA"
      Tab(2).Control(24).Enabled=   0   'False
      Tab(2).Control(25)=   "cboProperty"
      Tab(2).Control(25).Enabled=   0   'False
      Tab(2).Control(26)=   "txtAMT"
      Tab(2).Control(26).Enabled=   0   'False
      Tab(2).Control(27)=   "txtEND_DATE"
      Tab(2).Control(27).Enabled=   0   'False
      Tab(2).Control(28)=   "txtSTART_DATE"
      Tab(2).Control(28).Enabled=   0   'False
      Tab(2).Control(29)=   "txtREVIEW_DATE"
      Tab(2).Control(29).Enabled=   0   'False
      Tab(2).Control(30)=   "txtNOTICE_DAYS"
      Tab(2).Control(30).Enabled=   0   'False
      Tab(2).Control(31)=   "cmdAgmntAddNew"
      Tab(2).Control(31).Enabled=   0   'False
      Tab(2).Control(32)=   "cmdAgmntCancel"
      Tab(2).Control(32).Enabled=   0   'False
      Tab(2).Control(33)=   "txtAGREEMENT_ID"
      Tab(2).Control(33).Enabled=   0   'False
      Tab(2).Control(34)=   "cmdSecondaryCode_NONEED"
      Tab(2).Control(34).Enabled=   0   'False
      Tab(2).Control(35)=   "cmdAgrTopSave"
      Tab(2).Control(35).Enabled=   0   'False
      Tab(2).Control(36)=   "txtOWNERSHIP_PERCENT"
      Tab(2).Control(36).Enabled=   0   'False
      Tab(2).Control(37)=   "cmdAgrTopEdit"
      Tab(2).Control(37).Enabled=   0   'False
      Tab(2).ControlCount=   38
      TabCaption(3)   =   "Bank/Payment Details"
      TabPicture(3)   =   "frmClientNew23.frx":091E
      Tab(3).ControlEnabled=   0   'False
      Tab(3).Control(0)=   "Frame14"
      Tab(3).Control(1)=   "fraBank(1)"
      Tab(3).Control(2)=   "fraBank(0)"
      Tab(3).Control(3)=   "Shape1(1)"
      Tab(3).ControlCount=   4
      TabCaption(4)   =   "Account History"
      TabPicture(4)   =   "frmClientNew23.frx":093A
      Tab(4).ControlEnabled=   0   'False
      Tab(4).Control(0)=   "Picture2"
      Tab(4).Control(1)=   "MSHFlexGrid1"
      Tab(4).Control(2)=   "Shape1(2)"
      Tab(4).ControlCount=   3
      TabCaption(5)   =   "Global Settings"
      TabPicture(5)   =   "frmClientNew23.frx":0956
      Tab(5).ControlEnabled=   0   'False
      Tab(5).Control(0)=   "tabFee"
      Tab(5).Control(1)=   "Shape1(3)"
      Tab(5).ControlCount=   2
      TabCaption(6)   =   "Memo/Attachemnt"
      TabPicture(6)   =   "frmClientNew23.frx":0972
      ...
      Begin VB.Frame fraOccupied 
         ...
         Begin VB.Label lblTenantIDLink 
            ...
            Height          =   195
            Left            =   1560
            MouseIcon       =   "frmClientNew23.frx":098E
      ...
      Begin TabDlg.SSTab tabFee 
         ...
         TabPicture(0)   =   "frmClientNew23.frx":0C98
         Tab(0).ControlEnabled=   -1  'True
         Tab(0).Control(0)=   "imgFeeTypes"
         Tab(0).Control(0).Enabled=   0   'False
         Tab(0).ControlCount=   1
         TabCaption(1)   =   "Payment Dates"
         TabPicture(1)   =   "frmClientNew23.frx":0CB4
         Tab(1).ControlEnabled=   0   'False
         Tab(1).Control(0)=   "cmdGSCancel"
         Tab(1).Control(1)=   "cmdGSEdit"
         Tab(1).Control(2)=   "cmdGSSave"
         Tab(1).Control(3)=   "txtFeeIsuDays"
         Tab(1).Control(4)=   "txtPayIsuDays"
         Tab(1).Control(5)=   "tabDates"
         Tab(1).Control(6)=   "Label83(0)"
         Tab(1).Control(7)=   "Label83(13)"
         ...
         Begin VB.PictureBox imgFeeTypes 
            ...
            Begin MSDataListLib.DataCombo cboFeeType 
               Bindings        =   "frmClientNew23.frx":0CD0
            ...
            Begin MSDataListLib.DataCombo cboFrequency 
               Bindings        =   "frmClientNew23.frx":0CEA
               DataSource      =   "adoFreq"
               Height          =   315
               Left            =   4125
               TabIndex        =   236
            ...
            Begin MSDataListLib.DataCombo cboChargeType 
               Bindings        =   "frmClientNew23.frx":0D00
         ...
         Begin TabDlg.SSTab tabDates 
            ...
            TabPicture(0)   =   "frmClientNew23.frx":0D1C
            Tab(0).ControlEnabled=   -1  'True
      ...
      Begin MSComctlLib.ImageList imgList 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmClientNew23.frx":0D8C
               Key             =   ""
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmClientNew23.frx":1666
               Key             =   ""
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmClientNew23.frx":1F40
               Key             =   ""
            EndProperty
            BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmClientNew23.frx":281A
               Key             =   ""
            EndProperty
         EndProperty
      End
   ...
   Begin VB.PictureBox picMain 
      ...
      Begin VB.ListBox lstResidency 
         Height          =   450
         ItemData        =   "frmClientNew23.frx":2B34
         Left            =   5640
         List            =   "frmClientNew23.frx":2B3E
         TabIndex        =   82
         Top             =   240
         Visible         =   0   'False
         Width           =   2000
