...
Begin VB.Form frmManagingAgnt 
   ...
   Begin TabDlg.SSTab tabSupplier 
      ...
      TabPicture(0)   =   "frmManagingAgnt.frx":08CA
      ...
      TabPicture(1)   =   "frmManagingAgnt.frx":08E6
      Tab(1).ControlEnabled=   0   'False
      Tab(1).Control(0)=   "txtFLX"
      Tab(1).Control(1)=   "cmdTaxList(0)"
      Tab(1).Control(2)=   "cmdSavePayments"
      Tab(1).Control(3)=   "cmdEditPayments"
      Tab(1).Control(4)=   "cmdCancelPayments"
      Tab(1).Control(5)=   "cmdPayType"
      Tab(1).Control(6)=   "cmdAccType"
      Tab(1).Control(7)=   "txtBankPayRef"
      Tab(1).Control(8)=   "txtAcName"
      Tab(1).Control(9)=   "txtAcNo"
      Tab(1).Control(10)=   "txtSortCode"
      Tab(1).Control(11)=   "Label1(30)"
      Tab(1).Control(12)=   "Label1(29)"
      Tab(1).Control(13)=   "Label1(28)"
      Tab(1).Control(14)=   "Label1(27)"
      Tab(1).Control(15)=   "Label1(26)"
      Tab(1).Control(16)=   "Label1(33)"
      Tab(1).Control(17)=   "Label1(25)"
      Tab(1).Control(18)=   "Label1(32)"
      Tab(1).Control(19)=   "Label1(31)"
      Tab(1).Control(20)=   "txtCodeVat"
      Tab(1).Control(21)=   "lblVatCode(0)"
      Tab(1).Control(22)=   "Label18(0)"
      Tab(1).Control(23)=   "Label1(3)"
      Tab(1).Control(24)=   "Label1(22)"
      Tab(1).Control(25)=   "cboAccType"
      Tab(1).Control(26)=   "cboPayType"
      Tab(1).Control(27)=   "Label4"
      Tab(1).Control(28)=   "Label3"
      Tab(1).Control(29)=   "Shape1(2)"
      Tab(1).Control(30)=   "Shape1(0)"
      Tab(1).Control(31)=   "Label1(20)"
      Tab(1).Control(32)=   "Label1(19)"
      Tab(1).Control(33)=   "Label1(18)"
      Tab(1).Control(34)=   "Label1(17)"
      Tab(1).Control(35)=   "Label2"
      Tab(1).Control(36)=   "txtPaymentTerms"
      Tab(1).Control(37)=   "Label1(7)"
      Tab(1).Control(38)=   "Shape1(3)"
      Tab(1).Control(39)=   "Shape1(1)"
      Tab(1).ControlCount=   40
      TabCaption(2)   =   "Account History"
      TabPicture(2)   =   "frmManagingAgnt.frx":0902
      ...
      TabPicture(3)   =   "frmManagingAgnt.frx":091E
      ...
      TabPicture(4)   =   "frmManagingAgnt.frx":093A
      ...
      TabPicture(5)   =   "frmManagingAgnt.frx":0956
      ...
      Begin VB.Frame Frame2 
         Caption         =   "Managing Agent Alternative Address :"
         Enabled         =   0   'False
         Height          =   3735
         Left            =   -67620
         TabIndex        =   31
   ...
   End
End
Attribute VB_Name = "frmManagingAgnt"
...
Private Sub cboPayType_Change()
   ...
   If txtSortCode.text = "" Then
      cboPayType.text = ""
      MsgBox "Please update Managing Agent's Bank details.", vbCritical + vbOKOnly, "BACS setting"
      Exit Sub
   End If
End Sub
...
Private Sub cmdDeleteFile_Click()
   ...
   DeleteAttachmentCombo cmbFiles, cmbFiles.Column(2), txtSupplierID.text, "Managing Agent"
...
Private Sub cmdSaveSupplier_Click()
   ...
   If Len(txtAcNo.text) > 0 And Len(txtAcNo.text) < 8 Then
      ...
      Exit Sub
   End If
If cboSupplierType.text <> UCase("Managing agent") Then
     ShowMsgInTaskBar "Please select 'Managing agent' as supplier type to continue.", , "N"
     Exit Sub
End If
   Dim adoConn As New ADODB.Connection
   ...
   ShowMsgInTaskBar "Managing Agent entry has been saved successfully."

   SetControls DefaultMode
   FORM_STATUS = "DetEdit"
   Me.Caption = "Managing Agents"
   ...
   cmdCancelPayments.Enabled = False
   cmdSavePayments.Enabled = False
   'I am commenting this for managing agent form
...
Private Sub FlxDemandsConfigure(conFlxGrid As Control)
   ...
   conFlxGrid.ColWidth(1) = 1000       'Managing Agent ID
   conFlxGrid.ColWidth(2) = 3000       'Managing Agent Name
...
Private Sub cmdSupplierType_Click(Index As Integer)
   ...
   sSQLQuery = "SELECT CODE, VALUE " & _
               "FROM SECONDARYCODE " & _
               "WHERE PRIMARYCODE = 'SCODE' AND CODE='MA'"
...
End Sub
Private Sub insertMA(adoConn As ADODB.Connection)
'added by anol 26 Jun 2015
   ...
   If rsSupplier.EOF Then
       ...
       rsSupplier!Value = "MANAGING AGENT"
       rsSupplier.Update
       rsSupplier.Close
...
'   Call WheelUnHook(Me.hWnd)
   ...
   'I am commening the below Code for Managing agent
'   'Added by anol 13 May 2015
'   'Lanlord table needs to be updated from Supplier table
'   'Should be alwys syncronized with supplier table where supplier type = 'LL'
'   'So I am deleting all record from landlord table and transferring all where supplier type = 'LL' from supplier table
