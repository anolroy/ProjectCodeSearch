...
Begin VB.Form frmAgent 
   ...
   Begin TabDlg.SSTab tabMain 
      ...
      TabPicture(0)   =   "frmAgent.frx":08CA
      Tab(0).ControlEnabled=   0   'False
      Tab(0).Control(0)=   "cmdAgentDetailsCancel"
      Tab(0).Control(0).Enabled=   0   'False
      Tab(0).Control(1)=   "cmdAgentDetailsEdit"
      ...
      TabPicture(1)   =   "frmAgent.frx":08E6
      ...
      TabPicture(2)   =   "frmAgent.frx":0902
...
Private Sub cboAgentSageSuppAC_LostFocus()
   If cboAgentSageSuppAC.text = "" Then
      ...
      Exit Sub
   Else
      txtAgentID.text = cboAgentSageSuppAC.text & Format(Date, "ssmmhhddmmyyyy")
   End If
End Sub
...
Private Sub cmdAgentDetailsSave_Click()
   ...
   conAgent.Connect = "DSN=" & Adsn & ";UID=;PWD="
...
'===========================================================================================
   ...
   If Not rstAgent.EOF Then
      MsgBox "This agent could not be deleted. This agent has property in the database." & _
            (Chr$(13) + Chr$(10)) & "To delete this agent delete all properties of this agent.", vbCritical + vbOKOnly, "Delete Not Possible"
      rstAgent.Close
      Set rstAgent = Nothing
      conAgent.Close
      Set conAgent = Nothing
   ...
   szSQL = "DELETE * FROM AGENT WHERE AGENTID = '" & txtAgentID.text & "';"
   Set rstAgent = conAgent.OpenResultset(szSQL, rdOpenStatic, rdConcurReadOnly)
