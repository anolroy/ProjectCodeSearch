...
'   frmPurchaseExpense.flxCrNt.TextMatrix(frmPurchaseExpense.flxCrNt.Row, frmPurchaseExpense.flxCrNt.Col) = flxSupplier.TextMatrix(flxSupplier.Row, flxSupplier.Col)
'   If Me.Caption = "SUPPLIER ACCOUNT" Then
'      frmPurchaseExpense.flxCrNt.TextMatrix(frmPurchaseExpense.flxCrNt.Row, 12) = "T" & flxSupplier.TextMatrix(flxSupplier.Row, 3)
'      frmPurchaseExpense.nTaxCode = TaxRate(CInt(flxSupplier.TextMatrix(flxSupplier.Row, 3)))
'      frmPurchaseExpense.flxCrNt.TextMatrix(frmPurchaseExpense.flxCrNt.Row, 6) = flxSupplier.TextMatrix(flxSupplier.Row, 2)
'   End If
'   If Me.Caption = "TAX CODE" Then
'      frmPurchaseExpense.nTaxCode = flxSupplier.TextMatrix(flxSupplier.Row, 1)
'      frmPurchaseExpense.VatCalculationCr
'   End If
'   Unload Me
End Sub
...
'   Me.Top = frmPurchaseExpense.Top + frmPurchaseExpense.flxCrNt.Top + (285 * frmPurchaseExpense.flxCrNt.Rows) + 1000
   Me.Left = frmPurchaseExpense.iCrFlxLeft
...
'            flxSupplier.TextMatrix(rRow, 0) = CStr(oSalesRecord.Fields.Item("ACCOUNT_REF").Value)
'            flxSupplier.TextMatrix(rRow, 1) = CStr(oSalesRecord.Fields.Item("NAME").Value)
