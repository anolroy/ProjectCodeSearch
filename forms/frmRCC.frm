...
Begin VB.Form frmRCC 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Rent Collection Chart"
   ClientHeight    =   5430
   ClientLeft      =   2760
   ClientTop       =   3750
   ClientWidth     =   5580
   ...
   Begin VB.Frame Frame1 
      Caption         =   "Rent Collection Period:"
      Height          =   735
      Left            =   120
      TabIndex        =   11
      Top             =   480
   ...
   Begin VB.CommandButton cmdGenerateReportButton 
      Caption         =   "Print Rent Collection Chart"
      Default         =   -1  'True
      Height          =   615
      Left            =   2040
      TabIndex        =   5
...
'   UpdateTenantBBF adoConn

   adoConn.Close
   Set adoConn = Nothing

   Set Report = reportApp.OpenReport(App.Path & szReportPath & "\RentCollectionChart.rpt")
