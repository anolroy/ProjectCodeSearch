...
Begin VB.Form frmSendBackup4Support 
   ...
   EndProperty
   Icon            =   "frmSendBackup4Support.frx":0000
   LinkTopic       =   "Form3"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   End
End
Attribute VB_Name = "frmSendBackup4Support"
...
'Debug.Print szSQL
   ...
   adoRst.Fields.Item("TemplateName").Value = IIf(Me.Caption = "BACS Email Template", _
                                                               "BACS Email Template", _
                                                               "Demand Email Template")
