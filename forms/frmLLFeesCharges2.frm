...
Begin VB.Form frmLLFeesCharges1 
   ...
   EndProperty
   Icon            =   "frmLLFeesCharges2.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   Begin TabDlg.SSTab tabFees 
      ...
      TabPicture(0)   =   "frmLLFeesCharges2.frx":1982
