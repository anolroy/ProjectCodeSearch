...
Begin VB.Form frmPreLesseeEvery 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Lessee Details Print"
   ClientHeight    =   10665
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   7860
   ...
   EndProperty
   Icon            =   "frmPreLesseeEvery.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   Begin VB.CommandButton cmdLabelList 
      Caption         =   ".."
      Height          =   300
      Left            =   6840
      TabIndex        =   33
   ...
   End
End
Attribute VB_Name = "frmPreLesseeEvery"
...
Private Sub LoadLabelList()
   ...
   txtSearchClientID.Left = 45
   '~~~ Added by Anol Configuring width and position of labels and search boxes.
   lblClientID.Caption = "Label ID"
   lblClientName.Caption = "Label Name"
'   lblClientID.Width = 1400
'   lblClientID.Left = 50
'   lblClientName.Width = 2600
'   lblClientName.Left = lblClientID.Left + flxClient.ColWidth(0)
...
'   rstRec.Open szSQL, adoConn, adOpenStatic, adLockReadOnly
            rRow = 1
           flxClient.TextMatrix(rRow, 0) = ""
           flxClient.TextMatrix(rRow, 1) = "Avery L7163"
           flxClient.TextMatrix(rRow, 2) = "Avery L7163"
           flxClient.RowHeight(rRow) = 240
           flxClient.AddItem ""
'           rRow = 2
'        While Not rstRec.EOF
...
Private Sub cmdLabelList_Click()
...
' Declare the report object
   ...
   Dim i As Integer
           ...
           Set Report = crxApplication.OpenReport(App.Path & szReportPath & "\LesseeLabelAveryL7163.rpt", 1)
