...
Begin VB.Form frmAuditTrail 
   ...
   Begin VB.Frame Frame6 
      ...
      Begin VB.CheckBox chkDetailed 
         ...
         Width           =   2220
      End
      Begin VB.CheckBox chkShowDeleted 
         Caption         =   "Show Deleted transactions"
         Height          =   195
         Left            =   585
         TabIndex        =   54
         Top             =   225
...
Private Sub UpdateDrCr4NC(adoConn As ADODB.Connection)
   ...
   If txtPropertyName.text = "ALL" Then
      szPropSrc = ""
   Else
      szPropSrc = "P.PropertyID = '" & txtPropertyName.text & "' AND "
   End If
   If txtFundName.Tag = "ALL" Then
      ...
      szFundBank = ""
   Else
      szFundDEPT_ID = "S.DEPT_ID = " & txtFundName.Tag & " AND "
      szFundPA = "P.FundID = " & txtFundName.Tag & " AND "
      szFundSageDepartment = "S.SageDepartment = " & txtFundName.Tag & " AND "
      szFundSA = "R.FundID = " & txtFundName.Tag & " AND "
      szFundSR = "S.SageDepartment = " & txtFundName.Tag & " AND "
      szFundBank = "B.DEPT_ID = " & txtFundName.Tag & " AND "
   End If
'--------------------------------------------------------------------------------------------------
...
'--------------------------------------------------------------------------------------------------
   ...
   szSQL = "SELECT S.NOMINAL_CODE AS NC, SUM(S.TOTAL_AMOUNT) AS T, P.TransactionType AS TT " & _
           ...
           "WHERE " & szFundDEPT_ID & szPropSrc & _
              "P.TRAN_DATE >= #" & Format(txtSCYRRStDt.text, "DD MMMM YYYY") & "# AND " & _
              "P.TRAN_DATE <= #" & Format(txtSCYRREnDt.text, "DD MMMM YYYY") & "# AND " & _
              "S.NOMINAL_CODE <> '0000' " & _
...
'Debug.Print szSQL
   ...
   While Not adoRst.EOF
      ...
      If adoNL.Fields.Item("DrCr").Value = "Cr" Then
         If adoRst.Fields.Item(2).Value = 6 Then _
               adoNL.Fields.Item("Credit").Value = Val(adoNL.Fields.Item("Credit").Value) + Val(adoRst.Fields.Item(1).Value)
         If adoRst.Fields.Item(2).Value = 7 Then _
               adoNL.Fields.Item("Credit").Value = Val(adoNL.Fields.Item("Credit").Value) - Val(adoRst.Fields.Item(1).Value)
      Else
         If adoRst.Fields.Item(2).Value = 6 Then _
               adoNL.Fields.Item("Debit").Value = Val(adoNL.Fields.Item("Debit").Value) + Val(adoRst.Fields.Item(1).Value)
         If adoRst.Fields.Item(2).Value = 7 Then _
               adoNL.Fields.Item("Debit").Value = Val(adoNL.Fields.Item("Debit").Value) - Val(adoRst.Fields.Item(1).Value)
      End If
      adoRst.MoveNext
...
'Debug.Print szSQL
   ...
   While Not adoRst.EOF
      If adoNL.Fields.Item("DrCr").Value = "Cr" Then
         If adoRst.Fields.Item(1).Value = 6 Then adoNL.Fields.Item("Credit").Value = Val(adoNL.Fields.Item("Credit").Value) + Val(adoRst.Fields.Item(0).Value)
         If adoRst.Fields.Item(1).Value = 7 Then adoNL.Fields.Item("Credit").Value = Val(adoNL.Fields.Item("Credit").Value) - Val(adoRst.Fields.Item(0).Value)
      Else
         If adoRst.Fields.Item(1).Value = 6 Then adoNL.Fields.Item("Debit").Value = Val(adoNL.Fields.Item("Debit").Value) + Val(adoRst.Fields.Item(0).Value)
         If adoRst.Fields.Item(1).Value = 7 Then adoNL.Fields.Item("Debit").Value = Val(adoNL.Fields.Item("Debit").Value) - Val(adoRst.Fields.Item(0).Value)
      End If
      adoRst.MoveNext
   Wend
   ...
   While Not adoRst.EOF
      ...
      If adoNL.Fields.Item("DrCr").Value = "Cr" Then
         adoNL.Fields.Item("Credit").Value = Val(adoNL.Fields.Item("Credit").Value) + _
               IIf(IsNull(adoRst.Fields.Item(1).Value), 0, (adoRst.Fields.Item(1).Value))
      Else
...
'--------------------------------------------------------------------------------------------------
   ...
   While Not adoRst.EOF
      ...
      Else
         If adoRst.Fields.Item(2).Value = 1 Then _
            adoNL.Fields.Item("Credit").Value = Val(adoNL.Fields.Item("Debit").Value) + (adoRst.Fields.Item(1).Value)
         If adoRst.Fields.Item(2).Value = 2 Then _
            adoNL.Fields.Item("Credit").Value = Val(adoNL.Fields.Item("Debit").Value) - (adoRst.Fields.Item(1).Value)
      End If
...
'Debug.Print szSQL
   ...
   If Not adoRst.EOF Then
      If adoNL.Fields.Item("DrCr").Value = "Cr" Then
         adoNL.Fields.Item("Credit").Value = Val(adoNL.Fields.Item("Credit").Value) - _
                                             Val(IIf(IsNull(adoRst.Fields.Item(0).Value), 0, adoRst.Fields.Item(0).Value))
      Else
         adoNL.Fields.Item("Debit").Value = Val(adoNL.Fields.Item("Debit").Value) - _
                                            Val(IIf(IsNull(adoRst.Fields.Item(0).Value), 0, adoRst.Fields.Item(0).Value))
      End If
...
'  All option selected
   If CBool(chkDetailed.Value) = False Then
        Set Report = reportApp.OpenReport(App.Path & szReportPath & "\AuditTrail.rpt")
   Else
        Set Report = reportApp.OpenReport(App.Path & szReportPath & "\AuditTrailDetails.rpt")
   End If
   ...
   If txtPropertyName.Tag <> "ALL" Then
        strSelectionFormula = strSelectionFormula & "{NLPOSTING.PROPERTY_ID} = '" & txtPropertyName.Tag & "'"
   End If
   If txtFundName.Tag <> "ALL" Then
        strSelectionFormula = strSelectionFormula & " AND {NLPOSTING.FUND_ID} = " & txtFundName.Tag & ""
   End If

   If CBool(chkShowDeleted.Value) = False Then
   ...
   Report.ParameterFields(12).AddCurrentValue CBool(chkShowDeleted.Value)
...
'   Me.Top = 100
   ...
   chkShowDeleted.BackColor = MODULEBACKCOLOR
