...
'   frmPurchaseExpense.flxBankPay.TextMatrix(frmPurchaseExpense.flxBankPay.Row, frmPurchaseExpense.flxBankPay.Col) = flxSupplier.TextMatrix(flxSupplier.Row, flxSupplier.Col)
'   If Me.Caption = "BANK" Then
'      frmPurchaseExpense.flxBankPay.TextMatrix(frmPurchaseExpense.flxBankPay.Row, 11) = "T1"
'      frmPurchaseExpense.nTaxCode = TaxRate(1)
''      frmPurchaseExpense.cmdBPCombo.ZOrder 1
'   End If
'   If Me.Caption = "TAX CODE" Then
'      frmPurchaseExpense.nTaxCode = flxSupplier.TextMatrix(flxSupplier.Row, 1)
'      frmPurchaseExpense.VatCalculationBK
'   End If
'   Unload Me
End Sub
...
'   Me.Top = frmPurchaseExpense.Top + frmPurchaseExpense.flxBankPay.Top + (285 * frmPurchaseExpense.flxBankPay.Rows) + 1000
   Me.Left = frmPurchaseExpense.iBkFlxLeft
...
'   Dim oSDO As SageDataObject120.SDOEngine
'   Dim oWS As SageDataObject120.Workspace
'   Dim oNominalData As SageDataObject120.NominalData
'
'   ' Declare Variables
'   Dim szDataPath As String
'
...
'      If oWS.Connect(szDataPath, sageUserName, sagePassword, "Example") Then
'
'         Set oNominalData = oWS.CreateObject("NominalData")
'         flxSupplier.Clear
'         Dim rRow As Integer
'         For rRow = 1 To oNominalData.Fields.Count
'            oNominalData.Read (rRow)
'            flxSupplier.TextMatrix(rRow, 0) = CStr(oNominalData.Fields.Item("ACCOUNT_REF").Value)
'            flxSupplier.TextMatrix(rRow, 1) = CStr(oNominalData.Fields.Item("NAME").Value)
'            flxSupplier.AddItem ""
'         Next rRow
'         'Disconnect
'         oWS.Disconnect
