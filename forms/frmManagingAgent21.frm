...
Begin VB.Form frmManagingAgent21 
   ...
   EndProperty
   Icon            =   "frmManagingAgent21.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   Begin TabDlg.SSTab tabMain 
      ...
      TabPicture(0)   =   "frmManagingAgent21.frx":08CA
      ...
      TabPicture(1)   =   "frmManagingAgent21.frx":08E6
      ...
      TabPicture(2)   =   "frmManagingAgent21.frx":0902
      ...
      TabPicture(3)   =   "frmManagingAgent21.frx":091E
      Tab(3).ControlEnabled=   0   'False
      Tab(3).Control(0)=   "fmeEventHistory"
      Tab(3).ControlCount=   1
      TabCaption(4)   =   "Memo/Attachemnt"
      TabPicture(4)   =   "frmManagingAgent21.frx":093A
   ...
   End
End
Attribute VB_Name = "frmManagingAgent21"
