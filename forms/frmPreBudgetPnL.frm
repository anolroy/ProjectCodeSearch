...
Begin VB.Form frmPreBudgetPnL 
   ...
   End
End
Attribute VB_Name = "frmPreBudgetPnL"
...
'   adoConn.Execute "DELETE GlobalSCDtls.* " & _
'                   "From GlobalSCDtls " & _
'                   "WHERE GlobalSCDtls.BudgetID NOT IN (SELECT BudgetID FROM GlobalSC);"
'issue  381 SQL that is taking long time to complete 20170512 fixed by anol
   adoConn.Execute "DELETE GlobalSCDtls.* From GlobalSCDtls LEFT JOIN GlobalSC ON GlobalSCDtls.BudgetID =GlobalSC.BudgetID WHERE  GlobalSC.BudgetID  IS NULL;"
